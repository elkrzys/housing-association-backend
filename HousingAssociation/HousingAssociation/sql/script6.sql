...
ALTER TABLE issues DROP CONSTRAINT "CK_issues_type_Enum";

ALTER TABLE issues DROP COLUMN type;

ALTER TABLE issues RENAME COLUMN is_resolved_or_cancelled TO is_resolved;

ALTER TABLE issues ADD is_cancelled boolean NOT NULL DEFAULT FALSE;

INSERT INTO "__EFMigrationsHistory" (migration_id, product_version)
VALUES ('20211213213627_ModifyIssueAndAnnouncement', '5.0.11');
