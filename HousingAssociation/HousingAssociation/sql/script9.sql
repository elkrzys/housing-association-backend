...
ALTER TABLE issues DROP CONSTRAINT fk_issues_locals_source_local_id;

DROP INDEX ix_issues_source_local_id;

CREATE TABLE locals_issues (
    issues_id integer NOT NULL,
    locals_id integer NOT NULL,
    CONSTRAINT pk_locals_issues PRIMARY KEY (issues_id, locals_id),
    CONSTRAINT fk_locals_issues_issues_issues_id FOREIGN KEY (issues_id) REFERENCES issues (id) ON DELETE CASCADE,
    CONSTRAINT fk_locals_issues_locals_locals_id FOREIGN KEY (locals_id) REFERENCES locals (id) ON DELETE CASCADE
);

CREATE INDEX ix_locals_issues_locals_id ON locals_issues (locals_id);

INSERT INTO "__EFMigrationsHistory" (migration_id, product_version)
VALUES ('20211214180857_AddLocalsIssues', '5.0.11');
