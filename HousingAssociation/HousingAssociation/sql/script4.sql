...
ALTER TABLE refresh_tokens ADD created_by_ip text NULL;
...
ALTER TABLE refresh_tokens ADD revoked_by_ip text NULL;
...
INSERT INTO "__EFMigrationsHistory" (migration_id, product_version)
VALUES ('20211114211258_ChangeUserRefreshToken', '5.0.11');
